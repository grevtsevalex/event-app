  ...
  <header class="bg-white">
    <nav class="mx-auto flex max-w-7xl items-center justify-between p-6 lg:px-8" aria-label="Global">
      <div class="flex lg:flex-1">
        <router-link to="/"><a class="-m-1.5 p-1.5">
      ...
      <div class="hidden lg:flex lg:flex-1 lg:justify-end">
        <router-link :to="buttonUrl"><a href="{{buttonUrl}}" class="text-sm font-semibold leading-6 text-gray-900">{{buttonTitle}} <span aria-hidden="true">&rarr;</span></a></router-link>
      </div>
      ...
      <DialogPanel class="fixed inset-y-0 right-0 z-10 w-full overflow-y-auto bg-white px-6 py-6 sm:max-w-sm sm:ring-1 sm:ring-gray-900/10">
        ...
        <div class="mt-6 flow-root">
          <div class="-my-6 divide-y divide-gray-500/10">
            ...
            <div class="py-6">
              <router-link :to="buttonUrl"><a class="-mx-3 block rounded-lg px-3 py-2.5 text-base font-semibold leading-7 text-gray-900 hover:bg-gray-50">{{buttonTitle}}</a></router-link>
            </div>
          </div>
        </div>
      </DialogPanel>
